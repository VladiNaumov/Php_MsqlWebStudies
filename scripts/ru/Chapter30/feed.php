...
<html>
    <head>
        <title>Демонстрация использования Instagram</title>
    ...
    <body>
        <div class="container">
            <h1>Последние фотографии в Instagram</h1>
            <div class="row">
                <div class="col-md-12">
                    <form class="form-horizontal" method="GET" action="feed.php">
                        <fieldset class="form-group">
                            <div class="col-xs-9 input-group">
                                <input type="text" class="form-control" id="tagQuery" name="tagQuery" placeholder="Поиск по тегу..." value="<?=$tag?>"/>
                                <span class="input-group-btn">
                                    <button type="submit" class="btn btn-primary"><i class="glyphicon glyphicon-search"></i> Искать</button>
                                </span>
                            </div>
                        </fieldset>
                    </form>
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer text-right">
                                    <?php if(!$photo['user_has_liked']): ?>
                                        <a data-media-id="<?=$photo['id']?>" href="#" class="btn btn-xs btn-primary like-button"><i class="glyphicon glyphicon-thumbs-up"></i> Нравится</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
